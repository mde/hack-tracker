...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://www.staging.yammer.com/dialog/oauth';
  options.tokenURL = options.tokenURL || 'https://www.staging.yammer.com/oauth2/access_token.json';
  
  OAuth2Strategy.call(this, options, verify);
  this.name = 'yammer-staging';
...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.get('https://www.staging.yammer.com/api/v1/users/current.json', accessToken, function (err, body, res) {
